               ...
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
                              ...
                              <tbody>
                                <?php 
                              		$nomor = 1;	
                                  $get_data = mysqli_query($conn, "select * from user_bos");
                              		while ($display=mysqli_fetch_array($get_data)){
                										$id_bos = $display['id_bos'];
                										$nama = $display['nama'];
                										$perusahaan = $display['nama_perusahaan'];
                										$bidang = $display['bidang'];
                                  ...
                                  <td><a href='php/delete_bos.php?Del=<?php echo $id_bos ?>'><input type='submit' value='Delete' id='editbtn'></a></td>
                              </tr>
                              <?php
                              $nomor++;
                         	}
